...
<?php wp_enqueue_style('fonts_ubuntu', bloginfo('stylesheet_directory') . '/stylesheets/fonts/ubuntu/stylesheet.css'); ?>
<?php wp_enqueue_style('fonts_ubuntu', bloginfo('stylesheet_directory') . '/stylesheets/fonts/linux-libertine/stylesheet.css'); ?>
