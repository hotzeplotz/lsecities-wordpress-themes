...
function generate_section($section_slug, $section_heading = false, $mode = MODE_FULL_LIST) {
  ...
  foreach($people as $person) {
    if($person->get_field('display_after')) { $display_after = new DateTime($pod->get_field('display_after')); }
    if($person->get_field('display_until')) { $display_until = new DateTime($pod->get_field('display_until')); }
