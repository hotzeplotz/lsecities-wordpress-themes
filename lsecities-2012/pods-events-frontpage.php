            ...
            <div class='top-content'>
              ...
              <header class='heading-image'>
                <div class='photospread wireframe'>
                  ...
                  <a href="https://www.youtube.com/watch?v=<?php echo $event_media_item['youtube_uri'] ?>"><img src="<?php echo get_stylesheet_directory_uri() . '/stylesheets/mediaelement/bigplay.png'; ?>" style="background: url('<?php echo $featured_image_uri; ?>'); center center black" alt="event photo" /></a>
                  <?php else: ?>
